...
def get_args_parser(subparsers):
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/home/xw6956/online-continual-learning/datasets', type=str, help='dataset path')
    subparsers.add_argument('--dataset', default='Split-Sketch', type=str, help='dataset name')
